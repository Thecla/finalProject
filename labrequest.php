	...
	<input type="submit" name="search" value="search" />
		...
		<div class="content_wrapper">
			<div id="sidebar">
				...
				<ul id="cats">
				<li><a href="Admin/patientlist.php">Patients</a></li><li>
				...
				<a href="labreport1.php">Laboratory Reports</a></li>
				</ul>
			...
			<li><a href="labtest.php">+ Lab Test Order</a></li>
			</ul>
			</div>
			<?php

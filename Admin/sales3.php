...
<div class="main_wrapper">
	...
	<input type="submit" name="search" value="search" />
		...
		<div class="content_wrapper">
			...
			<form method="POST" action="sales3.php">
	...
	<?php
			echo "
			<tr>
			<td><a href='sales3.php?add=$product_id'>Add</a></td>
			<td>$product_name</td>			
			<td>$price</td>
				...
				<button><a href="salesinvoice3.php" style="text-decoration:none; color:black">process payment</a></button>
			</form>

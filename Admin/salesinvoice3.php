...
<div class="main_wrapper">
	...
	<input type="submit" name="search" value="search" />
		...
		<div class="content_wrapper">
			...
			<br />
			<form action ="salesinvoice3.php" method="post" enctype="multipart/form-data">
...
foreach($_SESSION as $name => $value){
	...
	<td><input type="text" name="balance" value="<?php echo $balance; ?>"/></td></tr>	
			...
			<button><a href="sales3.php" style="text-decoration:none; color:black">Add More Items</a></button>
		</div>
			</div>
...
$product_id=$_GET['add'];
	...
	header("Location:salesinvoice3.php");
}

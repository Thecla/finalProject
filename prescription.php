...
<div class="main_wrapper">
		...
		<div class="content_wrapper">
			<div id="sidebar" Style="height:710px">
				...
				<a href="prescription.php">Manage Prescription</a></li>
			...
			<div id="department">
			<ul>
			<li><a href="prescriptionlist.php">Prescription List</a></li>
...
global $con;
		 ...
		 $insert_doc= "insert into prescription (doc_name, national_id,case_history,drug_prescription,date,description) values('$doc_title','$national_id','$case_history','$drug_prescription',now(),'$description')";
